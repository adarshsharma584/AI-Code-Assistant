  ...
  const handleReview = async () => {
    ...
    try {
      ...
      const errorMessage =
        ...
        "Failed to get review. Please try again.";
                  ...
                  <div
                    ...
                    className={`p-4 hover:bg-gray-700/50 cursor-pointer group relative transition-colors duration-200 ${
                      currentSessionId === chat._id
                        ? "bg-gray-700/70 border-l-4 border-blue-400"
                  ...
                  components={{
                    code({ node, inline, className, children, ...props }) {
                      ...
                      return !inline && match ? (
                        <div className="rounded-xl overflow-hidden my-6 border border-gray-700 shadow-lg">
                          <div className="bg-gray-800/80 px-4 py-2.5 text-xs font-mono text-gray-300 border-b border-gray-700 flex items-center justify-between">
                            ...
                            <button className="text-gray-400 hover:text-gray-200 transition-colors">
                              ...
                              >
                                <path
                                  d="M8 5H6C4.89543 5 4 5.89543 4 7V19C4 20.1046 4.89543 21 6 21H17C18.1046 21 19 20.1046 19 19V18"
                                  stroke="currentColor"
                                  strokeWidth="2"
                                  strokeLinecap="round"
                        ...
                        <code
                          className={`${className} bg-gray-800/80 text-pink-400 px-2 py-1 rounded-md font-mono text-sm border border-gray-700`}
                          {...props}
                        >
                          {children}
                        </code>
                    ...
                    blockquote: ({ node, ...props }) => (
                      <blockquote
                        className="border-l-4 border-blue-500 pl-4 my-4 text-gray-300 italic"
                        {...props}
                      />
                    ),
                  }}
