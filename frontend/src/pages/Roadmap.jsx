    ...
    <div className="flex flex-col h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-gray-100">
      ...
      <div className="flex flex-1 overflow-hidden">
          ...
          <div className="w-72 bg-gray-800 border-r border-gray-700 overflow-y-auto transition-all duration-300 ease-in-out">
            <div className="p-4 border-b border-gray-700 bg-gray-800 sticky top-0 z-10">
              ...
              <p className="text-xs text-gray-400 mt-1">
                Your previous roadmap sessions
              </p>
            </div>
                ...
                return (
                  <div
                    ...
                    className={`p-4 hover:bg-gray-700/50 cursor-pointer group relative transition-colors duration-200 ${
                      currentSessionId === roadmap._id
                        ? "bg-gray-700/70 border-l-4 border-purple-400"
                ...
                <div className="p-8 text-center">
                  <div className="bg-gray-800/50 rounded-xl p-6 max-w-xs mx-auto">
                    ...
                    <p className="text-gray-400 text-sm">
                      No roadmap sessions yet
                    </p>
                    <p className="text-gray-500 text-xs mt-1">
                      Create a new roadmap to begin
                    </p>
                    <button
                      onClick={startNewRoadmap}
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
                  ...
                  components={{
                    code({ node, inline, className, children, ...props }) {
                      ...
                      return !inline && match ? (
                        <div className="rounded-xl overflow-hidden my-6 border border-purple-900/50 shadow-lg">
                          <div className="bg-purple-900/80 px-4 py-2.5 text-xs font-mono text-purple-200 border-b border-purple-800 flex items-center justify-between">
                            ...
                            >
                              ...
                              >
                                <path
                                  d="M8 5H6C4.89543 5 4 5.89543 4 7V19C4 20.1046 4.89543 21 6 21H15C16.1046 21 17 20.1046 17 19V18"
                                  stroke="currentColor"
                                  strokeWidth="2"
                                  strokeLinecap="round"
                                ...
                                />
                                <path
                                  d="M15 5C15 3.89543 15.8954 3 17 3H19C20.1046 3 21 3.89543 21 5V17C21 18.1046 20.1046 19 19 19H17"
                                  stroke="currentColor"
                                  strokeWidth="2"
                                  strokeLinecap="round"
                                />
                        ...
                        <code
                          className={`${className} bg-purple-900/30 text-purple-300 px-2 py-0.5 rounded-md font-mono text-sm border border-purple-800/50`}
                          {...props}
                        >
                          {children}
                        </code>
                    ...
                    blockquote: ({ node, ...props }) => (
                      <blockquote
                        className="border-l-4 border-purple-500 pl-4 my-6 text-gray-300 italic bg-purple-900/10 py-2 rounded-r-lg"
                        {...props}
                      />
                    ),
                  }}
          ...
          {/* Input Area */}
          <div
            className={`border-t border-gray-700 bg-gray-800/50 backdrop-blur-sm transition-all duration-300 ${
              ...
              >
                <div className="mb-4">
                  <p className="text-sm text-gray-400 mb-2">
                    Describe the topic or technology you want a roadmap for:
                  </p>
                  <div className="relative">
                    <textarea
                      ref={textareaRef}
                ...
                <div className="mt-auto pt-4 border-t border-gray-700">
                  <p className="text-xs text-gray-500 text-center">
                    Tip: Be specific about your goals and current skill level
                    for a more tailored roadmap.
                  </p>
                </div>
              </form>
            )}
