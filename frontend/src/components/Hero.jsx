    ...
    <div className="h-screen w-screen bg-black flex">
      ...
      <div className="w-1/2 h-full flex flex-col justify-center px-16 bg-black text-white">
        ...
        <div className="flex gap-4">
          <button className="px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg hover:opacity-90 transition-all duration-300 font-semibold">
            Get Started
          </button>
          <button className="px-8 py-3 border border-white/20 rounded-lg hover:bg-white/10 transition-all duration-300">
            Learn More
          </button>
        </div>
      </div>
